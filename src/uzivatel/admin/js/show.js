  ...
  for (var i = 0; i < json.users.length; i++) {
    ...
    removeButton.onclick = function()
    {
      ...
      confirmButton.onclick = function(){
        ajax('removeUser.php', JSON.stringify({username: obj.username}), function(e)
        {
    ...
    changePasswordButton.onclick = function(){
      ...
      confirmButton.onclick = function()
      {
        ...
        ajax('changeUserPassword.php', JSON.stringify({username: obj.username, newpassword: newPass}), function(e)
        {
          let parsedjson = JSON.parse(e);
          if(parsedjson.success)
          {
    ...
    changeRoleButton.onclick = function(){
      ...
      confirmButton.onclick = function(){
        ...
        ajax("changeUserRole.php", JSON.stringify({username: obj.username, newrole: roleIndex}), function(e)
        {
          let parsedjson = JSON.parse(e);

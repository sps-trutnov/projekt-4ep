...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlertViewComponent = /** @class */ (function () {
                ...
                Object.defineProperty(AlertViewComponent.prototype, "activeAlerts", {
                    get: function () {
                ...
                AlertViewComponent.prototype.getAlertClass = function (alert) {
                    switch (alert.type) {
            ...
            AlertViewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlertService = /** @class */ (function () {
                ...
                AlertService.prototype.show = function (message, type) {
                    var _this = this;
                    if (type === void 0) { type = _alert_type__WEBPACK_IMPORTED_MODULE_2__["AlertType"].info; }
                    var alert = new _alert__WEBPACK_IMPORTED_MODULE_3__["Alert"](message, type);
                    this.active.push(alert);
                    setTimeout(function () { return _this.active.shift(); }, 2000);
                };
                return AlertService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppInitializeService = /** @class */ (function () {
                function AppInitializeService(userService, signInService) {
                    this.userService = userService;
                    this.signInService = signInService;
                }
                AppInitializeService.prototype.intialize = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var user;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.userService.getSignedIn().toPromise()];
                                case 1:
                                    user = _a.sent();
                                    if (user !== null)
            ...
            AppInitializeService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function createAppInitializer(appInitializeService) {
                ...
                return function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, appInitializeService.intialize()];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignInService = /** @class */ (function () {
                ...
                Object.defineProperty(SignInService.prototype, "signedUser", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var UserNameAlreadyUsedError = /** @class */ (function (_super) {
                __extends(UserNameAlreadyUsedError, _super);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.getAll = function (options) {
                    ...
                    return this.httpClient.get(this.apiUrl + "/users/index.php", { params: parameters }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (u) { return u.map(function (u) { return new _user__WEBPACK_IMPORTED_MODULE_5__["User"](u.id, u.userName, u.firstName, u.lastName, u.email, u.isLibrarian, u.isAdministrator); }); }));
                };
                UserService.prototype.getById = function (id) {
                    return this.httpClient.get(this.apiUrl + "/users/index.php?id=" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (u) { return new _user__WEBPACK_IMPORTED_MODULE_5__["User"](u.id, u.userName, u.firstName, u.lastName, u.email, u.isLibrarian, u.isAdministrator); }));
                };
                UserService.prototype.getSignedIn = function () {
                    return this.httpClient.get(this.apiUrl + "/users/index.php?id=").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return e.status === 401 ? Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null) : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(e); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (u) { return u === null ? null : new _user__WEBPACK_IMPORTED_MODULE_5__["User"](u.id, u.userName, u.firstName, u.lastName, u.email, u.isLibrarian, u.isAdministrator); }));
                };
                UserService.prototype.add = function (user, password) {
                    var id = user.id, withoutId = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](user, ["id"]);
                    var withPassword = Object.assign({}, withoutId, { password: password });
                    return this.httpClient.post(this.apiUrl + "/users/index.php", withPassword).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return e.status === 409 ? Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(new _user_name_already_used_error__WEBPACK_IMPORTED_MODULE_6__["UserNameAlreadyUsedError"]()) : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(e); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (u) { return new _user__WEBPACK_IMPORTED_MODULE_5__["User"](u.id, u.userName, u.firstName, u.lastName, u.email, u.isLibrarian, u.isAdministrator); }));
                };
                UserService.prototype.update = function (user, password) {
                    var userData = password === undefined ? user : Object.assign({}, user, { password: password });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var User = /** @class */ (function () {
                function User(id, userName, firstName, lastName, email, isLibrarian, isAdministrator) {
                    this.id = id;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfirmDialogComponent = /** @class */ (function () {
                ...
                ConfirmDialogComponent.prototype.ngAfterViewInit = function () {
                    ...
                    modalElement.modal({});
                    modalElement.on("hidden.bs.modal", function () { return _this.close.emit(_this.confirmed); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var WithCredentialsHttpInterceptor = /** @class */ (function () {
                function WithCredentialsHttpInterceptor() {
                }
                WithCredentialsHttpInterceptor.prototype.intercept = function (request, next) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (":host {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n\n.alert-view-container {\n  pointer-events: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainNavigationComponent = /** @class */ (function () {
                ...
                Object.defineProperty(MainNavigationComponent.prototype, "signedUser", {
                    get: function () {
                ...
                MainNavigationComponent.prototype.signOut = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserViewModel = /** @class */ (function () {
                ...
                Object.defineProperty(UserViewModel.prototype, "isChanged", {
                    get: function () {
                ...
                Object.defineProperty(UserViewModel.prototype, "isUserNameValid", {
                    get: function () {
                ...
                Object.defineProperty(UserViewModel.prototype, "isPasswordValid", {
                    get: function () {
                ...
                Object.defineProperty(UserViewModel.prototype, "isEmailValid", {
                    get: function () {
                ...
                Object.defineProperty(UserViewModel.prototype, "isValid", {
                    get: function () {
                ...
                UserViewModel.prototype.resetToOriginal = function () {
                    if (this.original !== null) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (":host {\n  display: flex;\n  flex-direction: column;\n}\n\n.editable-cell {\n  background: initial;\n  border: none;\n  box-shadow: none !important;\n}\n\n.editable-cell.is-invalid {\n  color: #dc3545;\n}\n\n.editable-cell.is-invalid::-webkit-input-placeholder {\n  color: #dc3545;\n}\n\n.editable-cell.is-invalid::-moz-placeholder {\n  color: #dc3545;\n}\n\n.editable-cell.is-invalid::-ms-input-placeholder {\n  color: #dc3545;\n}\n\n.editable-cell.is-invalid::placeholder {\n  color: #dc3545;\n}\n\n.table-column-fill {\n  width: calc(100% / 5);\n}\n\n.table-column-id {\n  min-width: 70px;\n}\n\n.cursor-pointer {\n  cursor: pointer;\n}\n\n.text-nowrap {\n  white-space: nowrap;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersComponent = /** @class */ (function () {
                function UsersComponent(userService, alertService) {
                    ...
                    this.filterForm.valueChanges.subscribe(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.users = undefined;
                                    return [4 /*yield*/, this.refreshUsers()];
                                case 1:
                                    _a.sent();
                                    if (!this.isFiltred)
                                        this.addNewUser();
                ...
                Object.defineProperty(UsersComponent.prototype, "hasChanges", {
                    get: function () {
                        var _this = this;
                        return this.users !== undefined && this.users.some(function (u) { return (u.isChanged || u.original === null) && u !== _this.newUser; });
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(UsersComponent.prototype, "isAllValid", {
                    get: function () {
                        var _this = this;
                        return this.users === undefined || this.users.every(function (u) { return u.isValid || u === _this.newUser; });
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(UsersComponent.prototype, "isFiltred", {
                    get: function () {
                ...
                Object.defineProperty(UsersComponent.prototype, "isIdFilterValid", {
                    get: function () {
                ...
                Object.defineProperty(UsersComponent.prototype, "changesText", {
                    get: function () {
                        if (this.users === undefined)
                            return "";
                        var changesCount = this.users
                ...
                UsersComponent.prototype.ngOnInit = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.refreshUsers()];
                                case 1:
                                    _a.sent();
                                    this.addNewUser();
                                    return [2 /*return*/];
                ...
                UsersComponent.prototype.ngDoCheck = function () {
                ...
                UsersComponent.prototype.refreshUsers = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var idFilterControl, idFilter, userNameFilter, firstNameFilter, lastNameFilter, emailFilter, isLibrarianFilter, isAdministratorFilter, options, _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    options = Object.assign({}, idFilter !== "" && !idFilterControl.invalid && { idFilter: parseInt(idFilter) }, userNameFilter !== "" && { userNameFilter: userNameFilter }, firstNameFilter !== "" && { firstNameFilter: firstNameFilter }, lastNameFilter !== "" && { lastNameFilter: lastNameFilter }, emailFilter !== "" && { emailFilter: emailFilter }, isLibrarianFilter !== false && { isLibrarianFilter: isLibrarianFilter }, isAdministratorFilter !== false && { isAdministratorFilter: isAdministratorFilter });
                                    _a = this;
                                    return [4 /*yield*/, this.userService.getAll(options).toPromise()];
                                case 1:
                                    _a.users = (_b.sent())
                                        .map(function (u) { return new _user_view_model__WEBPACK_IMPORTED_MODULE_4__["UserViewModel"](u, u.userName, "", u.firstName, u.lastName, u.email, u.isLibrarian, u.isAdministrator); });
                                    return [2 /*return*/];
                            }
                        });
                    });
                ...
                UsersComponent.prototype.save = function (user) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var newUser, u, newPassword, e_1, u, e_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(user.original != null)) return [3 /*break*/, 5];
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, this.userService.update(u, newPassword).toPromise()];
                                case 2:
                                    newUser = _a.sent();
                                    return [3 /*break*/, 4];
                                case 3:
                                    e_1 = _a.sent();
                                    if (e_1 instanceof src_app_core_users_user_name_already_used_error__WEBPACK_IMPORTED_MODULE_7__["UserNameAlreadyUsedError"]) {
                                ...
                                case 5:
                                    u = new src_app_core_users_user__WEBPACK_IMPORTED_MODULE_3__["User"](0, user.newUserName, user.newFirstName, user.newLastName, user.newEmail, user.newIsLibrarian, user.newIsAdministrator);
                                    _a.label = 6;
                                case 6:
                                    _a.trys.push([6, 8, , 9]);
                                    return [4 /*yield*/, this.userService.add(u, user.newPassword).toPromise()];
                                case 7:
                                    newUser = _a.sent();
                                    return [3 /*break*/, 9];
                                case 8:
                                    e_2 = _a.sent();
                                    if (e_2 instanceof src_app_core_users_user_name_already_used_error__WEBPACK_IMPORTED_MODULE_7__["UserNameAlreadyUsedError"]) {
                                        this.alertService.show("U\u017Eivatelsk\u00E9 jm\u00E9no '" + u.userName + "' ji\u017E pou\u017E\u00EDv\u00E1 n\u011Bkdo jin\u00FD.", src_app_alerts_alert_type__WEBPACK_IMPORTED_MODULE_6__["AlertType"].error);
                                        return [2 /*return*/];
                                    }
                                    throw e_2;
                ...
                UsersComponent.prototype.discard = function (user) {
                ...
                UsersComponent.prototype.remove = function (user) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.userService.remove(user.original).toPromise()];
                                case 1:
                                    _a.sent();
                                    this.users.splice(this.users.indexOf(user), 1);
                                    return [2 /*return*/];
                ...
                UsersComponent.prototype.saveAll = function () {
                    var _this = this;
                    this.users
                        .filter(function (u) { return u.isChanged; })
                        .forEach(function (u) { return _this.save(u); });
                };
                UsersComponent.prototype.discardAll = function () {
                    var _this = this;
                    this.users
                        .filter(function (u) { return u.isChanged || u.original === null && u !== _this.newUser; })
                        .forEach(function (u) { return _this.discard(u); });
                };
                UsersComponent.prototype.idFilterValidator = function (control) {
                    if (/^(0|(-?[1-9][0-9]*)|)$/.test(control.value))
                        return null;
                    else
                        return { invalidId: true };
                };
                UsersComponent.prototype.import = function () {
                    var _this = this;
                    var kontrola = 0;
                    var validniRadky = [];
                        ...
                        reader.onload = function () {
                            ...
                            for (var i = 0; i < radky.length; i++) {
                                ...
                                if (atributyUsera.length != 7 || (atributyUsera[5] != "true" && atributyUsera[5] != "false") || (atributyUsera[6] != "true" && atributyUsera[6] != "false")) {
                                    _this.alertService.show("Chyba na řádku " + (i + 1), src_app_alerts_alert_type__WEBPACK_IMPORTED_MODULE_6__["AlertType"].error);
                                    kontrola++;
                                }
                                else {
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    soubor = "";
                                    return [4 /*yield*/, this.userService.getAll().toPromise()];
                                case 1:
                                    uzivatele = _a.sent();
                ...
                UsersComponent.prototype.downloadBlob = function (fileName, blob) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignedInCanActivate = /** @class */ (function () {
                function SignedInCanActivate(signInService, signInUrl) {
                    this.signInService = signInService;
                    this.signInUrl = signInUrl;
                }
                SignedInCanActivate.prototype.canActivate = function (route, state) {
            ...
            SignedInCanActivate.ctorParameters = function () { return [
                { type: src_app_core_sign_in_sign_in_service__WEBPACK_IMPORTED_MODULE_2__["SignInService"] },
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Users\jorka\Desktop\projekt\projekt-4ep\src\sysadmin\client\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
